...
class Eventselection1 {
public :
   Eventselection1 ();
   inline virtual ~Eventselection1(){};
...
private:
   ...
   static constexpr Int_t kMaxParticle = 9383;
   static constexpr Int_t kMaxTrack = 352;
   static constexpr Int_t kMaxTower = 651;
   static constexpr Int_t kMaxEFlowTrack = 352;
   static constexpr Int_t kMaxEFlowPhoton = 222;
   static constexpr Int_t kMaxEFlowNeutralHadron = 319;
   static constexpr Int_t kMaxGenJet = 29;
   ...
   static constexpr Int_t kMaxFatJet = 8;
