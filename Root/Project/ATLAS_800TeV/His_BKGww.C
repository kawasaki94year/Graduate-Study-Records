...
Eventselection2::Eventselection2(){
}

void Eventselection2::Draw_BKGww(){
  TChain *BKG_mu_tree = new TChain("Delphes");//tree name
  BKG_mu_tree->Add("/home/xwl/Analysis/Root/pp/background/ww_100TeV_800.root");
	   //muon
  ...
  BKG_mu_tree->SetBranchAddress("Jet.Eta", Jet_Eta, &b_Jet_Eta);
           //output root file
  //TFile *f = new TFile("/home/xwl/Analysis/pp-100TeV/ATLAS_800TeV/Root/bkgww1_800.root","recreate");
  TFile *f = new TFile("/home/xwl/Analysis/pp-100TeV/ATLAS_800TeV/Root/bkgww1_800_cut.root","recreate");
           //creat histogram
	  ...
	  if(Electron_PT[0] > 100 &&  Muon_PT[0] > 100 && l_MET > 300){
	    ...
	    if(ll_M > 130 && MTemu > 100){
	      ...
	      h1H_MT2->Fill(MTemu);
              ...
              cout<<"entries3 = "<<neventsBKG<<endl;
	    }
	  }
        }
	num_cut = num_cut1 + num_cut2 + num_cut3;
	eff_cut = eff_cut1 + eff_cut2 + eff_cut3;
	cout<<"ww:num_cut = "<<num_cut<<";"<<"eff_cut = " << eff_cut << endl;
	
	cout<<"ww:num_cut1 for ee="<<num_cut1<<endl;
	cout<<"ww:eff_cut1 for ee="<<eff_cut1<<endl;
	
	cout<<"ww:num_cut2 for mu mu="<<num_cut2<<endl;
	cout<<"ww:eff_cut2 for mu mu="<<eff_cut2<<endl;
	
	cout<<"ww:num_cut3 for emu="<<num_cut3<<endl;
	cout<<"ww:eff_cut3 for emu="<<eff_cut3<<endl;
      }
    }
  }
  f->Write();
