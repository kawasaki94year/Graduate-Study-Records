...
class Eventselection3 {
public :
   Eventselection3();
   inline virtual ~Eventselection3(){};
...
private:
   ...
   static constexpr Int_t kMaxParticle = 9103;
   static constexpr Int_t kMaxTrack = 302;
   static constexpr Int_t kMaxTower = 580;
   static constexpr Int_t kMaxEFlowTrack = 302;
   static constexpr Int_t kMaxEFlowPhoton = 205;
   static constexpr Int_t kMaxEFlowNeutralHadron = 329;
   static constexpr Int_t kMaxGenJet = 26;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxJet = 22;
