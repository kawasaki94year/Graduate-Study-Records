...
class Eventselection2 {
public :
   Eventselection2();
   inline virtual ~Eventselection2(){};
...
private:
   ...
   static constexpr Int_t kMaxParticle = 9257;
   static constexpr Int_t kMaxTrack = 304;
   static constexpr Int_t kMaxTower = 567;
   static constexpr Int_t kMaxEFlowTrack = 304;
   static constexpr Int_t kMaxEFlowPhoton = 189;
   static constexpr Int_t kMaxEFlowNeutralHadron = 323;
